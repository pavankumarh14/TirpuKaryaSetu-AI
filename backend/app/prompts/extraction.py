...
Output schema:
{
  "case_metadata": {
    ...
    "bench_judge": "bench or judge name string or null",
  ...
  "actions": [
    {
      ...
      "action_type": "compliance|appeal|both|information",
      "responsible_authority": "specific officer, cell, or authority responsible, or null",
      "nature_of_action": "short classification of the action required",
      ...
      "appeal_recommendation": "short recommendation on whether appeal should be considered, or null",
      "limitation_period": "appeal limitation period or compliance limitation phrase, or null",
